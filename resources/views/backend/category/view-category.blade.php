  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Category Manage</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
             ...
             @foreach($allData as $key => $category)
                <tr>
                  ...
                  <td>
                  	...
                  	<a href="{{ route('categories.delete',$category->id)}}" id="delete" class="btn btn-sm btn-danger" title="delete"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
            @endforeach
