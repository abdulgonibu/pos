  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Supplier Manage</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
             ...
             @foreach($allData as $key => $supplier)
                <tr>
                  ...
                  <td>
                    ...
                    @if($count_supplier<-1)
                  	<a href="{{ route('suppliers.delete',$supplier->id)}}" id="delete" class="btn btn-sm btn-danger" title="delete"><i class="fa fa-trash"></i></a>
                    @endif
                  </td>
                </tr>
            @endforeach
