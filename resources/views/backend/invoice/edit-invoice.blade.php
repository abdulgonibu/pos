              	...
              	<form method="post" action="{{ route('products.update', $editData->id)}}" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select name="supplier_id" class="form-control">
                        ...
                        <option value="{{$supplier->id}}" {{($editData->supplier_id==$supplier->id)?"selected":''}}>{{$supplier->name}}
                        </option>
                        @endforeach
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select name="category_id" class="form-control">
                        ...
                        <option value="{{$category->id}}" {{($editData->category_id==$category->id)?"selected":''}}>{{$category->name}}
                        </option>
                        @endforeach
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select name="unit_id" class="form-control">
                        ...
                        <option value="{{$unit->id}}" {{($editData->unit_id==$unit->id)?"selected":''}}>{{$unit->name}}
                        </option>
                        @endforeach
