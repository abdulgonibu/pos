                  ...
                  <table class="table-sm table-bordered" width="100%">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" name="discount_amount" id="discount_amount" class="form-control form-control-sm" placeholder="Enter Discount amount"></td>
                      </tr>
                      <tr>
                        <td class="text-right" colspan="4">Ground Total</td>
                        <td>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-row">
                      ...
                      <select name="customer_id" id="customer_id" class="form-control">
                        ...
                        <option value="{{$customer->id}}">{{$customer->name}} ({{$customer->mobile_no}} - {{$customer->address}})
                        </option>
                        @endforeach
